...
void test(const HttpRequest &request, HttpResponse *response)
{
  ...
  body.append(
      "<a "
      "href='https://www.cnblogs.com/coderzh/archive/2009/04/06/"
      "1426755.html'>Google Test</a><p>");
  body.append(
      "<a "
      "href='https://www.cnblogs.com/huxiao-tee/p/4660352.html'>mmap</a><p>");
  body.append(
      "<a href='https://www.cnblogs.com/sench/p/8933638.html'>umak</a><p>");
  body.append(
      "<a "
      "href='http://www.https://www.cnblogs.com/x_wukong/p/"
      "10848069.html.com'>errno数值意义</a><p>");
